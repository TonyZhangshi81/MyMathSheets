...
namespace MyMathSheets.CommonLib.Main.HtmlSupport
{
        ...
        where T : TopicParameterBase
    {
		...
		protected virtual void PreMakeHtmlContent(T parameter)
        {
        }
		...
		/// </summary>
		/// <param name="parameter">参数对象</param>
		protected virtual void PostMakeHtmlContent(T parameter)
        {
        }
